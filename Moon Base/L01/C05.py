Briefing
'''
So you've already learnt about strings, 
but did you know there are some other really useful things you can do with them? 
Things like concatenation and using string specifiers. Take a look.
'''
