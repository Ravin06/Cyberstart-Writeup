Briefing
'''
Are you any good at maths agent? 
Well, computers certainly are, and you can use programming to do all kinds of clever things. 
Let's start you off with the basics, using programming to do some simple calculations.
'''
